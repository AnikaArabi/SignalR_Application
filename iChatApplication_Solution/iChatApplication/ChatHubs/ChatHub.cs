...
namespace iChatApplication.ChatHubs
{
    public class ChatHub:Hub
    {
        private static Dictionary<string, string> users = new Dictionary<string, string>();
        private readonly IWebHostEnvironment environment;
        public ChatHub(IWebHostEnvironment environment)
        {
        ...
        public async Task Attatch(string username)
        {
        ...
        {
            string path = Path.Combine(this.environment.WebRootPath, "Pictures");
